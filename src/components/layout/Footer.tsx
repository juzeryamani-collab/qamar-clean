    ...
    <footer className="bg-brand-surface border-t border-brand-border">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <p className="text-brand-muted text-sm leading-relaxed max-w-xs">
              Houston&apos;s trusted builder for medical clinics, dental offices, and urgent care centers. Turnkey design-build, done right.
            </p>
            <div className="gold-divider" />
            <p className="text-brand-muted text-xs uppercase tracking-widest font-oswald">Serving Houston &amp; Surrounding Areas</p>
          </div>
      ...
      <div className="border-t border-brand-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-brand-muted text-xs font-lato">&copy; {new Date().getFullYear()} Qamar Construction. All rights reserved.</p>
          <p className="text-brand-muted text-xs font-lato">Houston, TX — Licensed &amp; Insured</p>
        </div>
      </div>
    </footer>
  )
