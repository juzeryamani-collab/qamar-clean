...
const defaultSteps: Step[] = [
  {
    ...
    title: 'Consultation',
    description:
      'We meet to understand your vision, patient-flow needs, equipment requirements, budget, and timeline. No obligations—just clarity.',
  },
  {
    number: '02',
    title: 'Design & Planning',
    description:
      'Our team produces architectural plans and interior design optimized for medical workflows, code compliance, and your brand.',
  },
  {
    number: '03',
    title: 'Permitting',
    description:
      "We handle all city permits, ADA compliance documentation, and medical-specific inspections so you don't have to.",
  },
  {
    number: '04',
    title: 'Construction',
    description:
      'Professional build using medical-grade materials and standards. You receive regular progress updates throughout.',
  },
  {
    number: '05',
    title: 'Turnkey Handoff',
    description:
      'Complete walkthrough, punch list resolution, and keys in hand. Your facility is ready to open from day one.',
  },
]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-14 text-center">
          ...
          <p className="text-brand-muted mt-4 max-w-xl mx-auto font-lato">
            From first conversation to final walkthrough — one team, one contract, zero surprises.
          </p>
        </div>
