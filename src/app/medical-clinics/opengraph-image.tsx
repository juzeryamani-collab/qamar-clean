...
export const alt = 'Medical Clinic Construction in Houston, TX — Qamar Construction'
...
export default function Image() {
  return new ImageResponse(
    (
      ...
      >
        <div style={{ position: 'absolute', left: 0, top: 0, width: 8, height: '100%', background: '#2dd4bf' }} />
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          <span style={{ color: '#2dd4bf', fontSize: 68, fontWeight: 700, lineHeight: 1.05 }}>
            Construction
          </span>
          <span style={{ color: '#9ca3af', fontSize: 24, marginTop: 20 }}>
            Primary care, specialty clinics &amp; multi-physician practices — turnkey design-build
          </span>
        </div>
